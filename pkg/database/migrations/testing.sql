...
INSERT INTO organisation.organisation(
	organisation_id, display_name, registration_no, contact_email, contact_phone, description, achievements, owner, type_of_org, location)
	VALUES (1, 'sfdf', 'fjdkf', 'dfjhj', 'hfjksd', 'fjdkf', 'dfjhj', 1, 0, ST_SetSRID(ST_MakePoint(69.856743, 42.020430), 4326));
